            ...
            try
            {
                ...
                switch (msgType)
                {
                        ...
                        if (msg.Length == 26)
                        {
                            ...
                            var spaceshipRows =
                                _dataAccess.GetByQuery(
                                    "SELECT idSpaceShip, CodeSpaceShip, IPSpaceShip, PortSpaceShip1 FROM SpaceShips WHERE CodeSpaceShip = @codespaceship",
                    ...
                    case "VK":
                    {
                        ...
                        {
                            _tcp.SendMessageToServer("code", _spaceShip.getIp(), _spaceShip.getPort());
                        }
